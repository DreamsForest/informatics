...
class Statistics20Page(MDBoxLayout):
    ...
    def show_content(self):
        ...
        task_stats = stats.get("task_20", {"correct": 0, "incorrect": 0, "total": 0})
        ...
        pie_chart = FixedPieChart20(correct, incorrect, size_hint_y=None, height=dp(250))
        ...
        simple_bar_chart = SimpleBarChart20(correct, incorrect, total, size_hint_y=None, height=dp(250))
